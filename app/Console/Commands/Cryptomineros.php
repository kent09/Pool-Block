...
class Cryptomineros extends Command
{
    protected $count = 0;
    /**
     ...
     * @var string
     */
    protected $signature = 'cryptomineros:blockspool';
    ...
    public function handle()
    {
        ...
        \App\Cryptominero::query()->truncate();
        $curl = curl_init();
        
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://sup-api.cryptomineros.com/stats",
    ...
    public function loopPage($lastHeight)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://sup-api.cryptomineros.com/get_blocks?height=".$lastHeight."",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
