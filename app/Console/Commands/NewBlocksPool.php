...
class NewBlocksPool extends Command
{
    protected $count = 0;
    /**
     ...
     * @var string
     */
    protected $signature = 'new:blockspool';
    ...
    public function handle()
    {
        ...
        \App\NewPool::query()->truncate();
        $curl = curl_init();
        
        curl_setopt_array($curl, array(
          CURLOPT_PORT => "8117",
          CURLOPT_URL => "https://superiorcoinpool.com:8117/stats",
    ...
    public function loopPage($lastHeight)
    {
        ...
        curl_setopt_array($curl, array(
        CURLOPT_PORT => "8117",
        CURLOPT_URL => "https://superiorcoinpool.com:8117/get_blocks?height=".$lastHeight."",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
